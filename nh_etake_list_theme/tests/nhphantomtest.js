// Phantomjs odoo helper - with IncludeJS
                ...
                // run test
                    ...
                    if(self.include){
                        self.page.evaluate(function(){
                            ...
                            // TODO: get this not returning undefined
                            console.log(self.include);
                            return eval('var s = document.createElement("script"); s.type = "text/javascript"; s.src="'+self.include+'"; document.head.appendChild(s);');
                        })
                    }
...
if(system.args.length === 2) {
    pt = new PhantomTest();
    //if(pt.options.include){
    //    pt.page.includeJs(pt.options.include, function(){
